...
(function () {
    ...
    // Navbar default style
    const defaultNavbarType = document.querySelector('[data-setting="navbar"][data-name="navs-transparent"]')
    if (defaultNavbarType !== null) {
        defaultNavbarType.addEventListener("click", (e) => {
            document.querySelector('.iq-navbar').classList.remove('nav-glass','navs-sticky', 'navbar-default')
